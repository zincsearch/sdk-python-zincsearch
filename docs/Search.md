...
------------- | ------------- | -------------
[**delete_by_query**](Search.md#delete_by_query) | **POST** /es/{index}/_delete_by_query | Searches the index and deletes all matched documents
...
# **delete_by_query**
> MetaHTTPResponseDeleteByQuery delete_by_query(index, query)
...
with zincsearch_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Searches the index and deletes all matched documents
        api_response = api_instance.delete_by_query(index, query)
        pprint(api_response)
    except zincsearch_sdk.ApiException as e:
        print("Exception when calling Search->delete_by_query: %s\n" % e)
```
...
# **search_v1**
> MetaSearchResponse search_v1(index, query)
